...
<html>
<title>Unauthenticated User Access to Admin</title>
<meta charset="UTF-8">
...
<div class="w3-main" style="margin-left:470px;margin-right:40px">
 ...
 <center><h1>Unauthenticated User Access to Admin</h1></center>
  <br><br>
  <center>
        <h3>Enter to your Account</h3><br>
    <form action="unauthenticated.php" method="POST">
  ...
  <h3> Bypass Authentication by replacing /unauthenticated.php with /admin.php in URL. </h3>
</center>
</section>
 <!-- page end -->
</div>
